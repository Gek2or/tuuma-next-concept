...
export const apartments: Apartment[] = [
  ...
  },
  {
    ...
    variant: "kalliolinna",
    type: "Rivitalo",
    available: "Täysi konseptiesimerkki valmis",
    balcony: false,
    sauna: false,
    pets: true,
    accessible: true,
    ...
    ev: true,
    transport: 8,
    tags: ["Täysi esimerkki valmis", "Lemmikit sallittu", "3D + 360°"],
  ...
  },
  {
    ...
    ev: true,
    transport: 8,
    tags: ["Täysi esimerkki valmis", "2 tasoa", "Oma piha"],
  ...
  },
  {
    ...
    ev: true,
    transport: 8,
    tags: ["Täysi esimerkki valmis", "4H + K", "Perheelle"],
