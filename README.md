...
**Rajat:** malleissa on mallinnetut kalusteet ja alkuperäinen materiaalikirjasto (tammi, posliinilaatta, pellava, kvartsitaso ja lämpökäsitelty puu). Ne eivät ole valokuvarealistisia laserkeilauksia tai oikean kohteen mittausaineistoa. Konseptikuvat havainnollistavat tunnelmaa eivätkä todista tilamallin mittoja. Huoneluettelon pinta-alat ovat suuntaa-antavia, eivät SFS-standardin mukaisesti varmennettuja huoneistoaloja; katalogin ilmoitusala ja luonnoksen tilapinta-ala voivat poiketa. Rakenteet, paloturvallisuus, esteettömyys, ikkunamitoitus ja rakennuspaikan kaava tulee tarkistaa pätevän suunnittelijan kanssa ennen käyttöä oikean kohteen asiakirjoina.
...
Syyskuun 2026 päivitys: C09, E15 ja F20 avautuvat yhteiseen Kuvat / Pohja / 3D / 360° -näkymään. Pohjat, kerrosten aukot ja U-portaat käyttävät yhteistä geometriaa. Esimerkkien kierros on reaaliaikainen tilamalli; galleriakuvat ovat tunnelmaa havainnollistavia konseptikuvia, eivät tämän mallin tarkkoja renderöintejä. Ammattimaisen valokuvakierroksen laatutasoa ei ole vielä todennettu. Tarkempi toteutus- ja tarkastusrajaus sekä kuvituksen alkuperä: [three-homes-review.md](docs/three-homes-review.md).

Palvelun hinnat, saatavuudet, analytiikka, hakemukset, huoltopyynnöt, energiamittaukset ja asukastiedot ovat mock-dataa. C09:n, E15:n ja F20:n julkiset osoite-, tyyppi- ja kokotiedot on erotettu itsenäisestä konseptisuunnittelusta. Lomakkeet eivät lähetä tietoja, tiedostot eivät siirry palvelimelle ja AI-apuri ei kutsu ulkoista kielimallia. Kolmen esimerkin kierros renderöi asuntokohtaisen tilamallin. Muissa esimerkeissä on lisäksi selvästi merkitty kuvitettu 360°-tila. Mallit käyttävät kuva- ja proseduraalitekstuureja; ne eivät vielä vastaa ammattimaista valokuvakierrosta. Tuotannollinen glTF/GLB-tuonti ja valokuvapanoraamojen julkaisuputki tarvitsevat erillisen lataus- ja validointikerroksen.
