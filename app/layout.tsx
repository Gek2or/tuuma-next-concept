...
export const metadata:Metadata={title:{default:"Tuuma Next — Digital Living Concept",template:"%s | Tuuma Next"},description:"Moderni digitaalinen asumisen palvelukonsepti — löydä koti, vertaile ja hoida asumisen asiat helposti.",manifest:"/manifest.webmanifest",robots:{index:false,follow:false},icons:{icon:"/favicon.svg"},other:{"codex-preview":"development"}};
